...
class DoneParserTest {
    ...
    private static final String ERROR_GOAL_INDEX_FORMAT = "Index expected after 'g/' flag missing.";
    private static final String ERROR_GOAL_INDEX_NON_INTEGER = "The flag 'g/' has to be followed by a number.";
    private static final String ERROR_HABIT_INDEX_FORMAT = "Index expected after 'h/' flag missing.";
    ...
    private static final String ERROR_MISSING_GOAL_FLAG = "The command is missing the 'g/' flag.";
    private static final String ERROR_MISSING_HABIT_FLAG = "The command is missing the 'h/' flag.";
    ...
    void parseDoneHabitCommand_missingParameters_exceptionThrown() {
        try {
            ...
            assertEquals(ERROR_MISSING_GOAL_FLAG, e.getMessage());
        }
    }
    ...
    void parseDoneHabitCommand_missingHabitIndex_exceptionThrown() {
        ...
        try {
            ...
            assertEquals(ERROR_MISSING_HABIT_FLAG, e.getMessage());
        }
    }

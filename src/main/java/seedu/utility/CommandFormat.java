...
public class CommandFormat {
    ...
    private static final String ADD_EXPENSE_FORMAT = "Adding Expense (Date Format: DD/MM/YYYY): add_ex d/DESCRIPTION a/AMOUNT c/CATEGORY [D/DATE]";
    ...
    private static final String ADD_INCOME_FORMAT = "Adding Income (Date Format: DD/MM/YYYY): add_in d/DESCRIPTION a/AMOUNT c/CATEGORY [D/DATE]";

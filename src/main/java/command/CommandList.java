...
public class CommandList {
    ...
    public static final String ADD_DISPENSE = "adddispense";
    ...
    public static final String LIST_DISPENSE = "listdispense";
    ...
    public static final String UPDATE_DISPENSE = "updatedispense";

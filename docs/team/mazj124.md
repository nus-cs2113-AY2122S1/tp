...
* **New Feature**: Added the `searchmap` command to search for mappings for an existing university.

* **New Feature**: Added the `find` command `to search for universities and modules based on the keyword input from
the user. 
...
* **Documentation**:
    ...
    * Developer Guide:
        * Added implementation and class diagram for university and module related classes

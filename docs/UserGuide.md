...
The **edit-item** command edits an existing item from a trip.
...
The **search-item** command searches for an item keyword from a trip and returns the resulting matching items.
